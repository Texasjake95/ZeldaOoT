...
public class EntityZeldaBomb extends Entity
{
	public int fuse;

    public EntityZeldaBomb(World par1World)
    {
        super(par1World);
        this.fuse = 90;
    ...
    public EntityZeldaBomb(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
