...
public class ZeldaRecipes {
	...
	public static void GetRecipes() {
			...
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(SpiritualStones, 1,1),  "XYX","XXX","YXY", 'X', Item.goldNugget, 'Y', "gemSapphire"));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(SpiritualStones, 1,0),  "XYX","XYX","XYX", 'X', Item.goldNugget, 'Y', "gemRuby"));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(SpiritualStones, 1,2),  "XYY","XYX","XXX", 'X', Item.goldNugget, 'Y', "gemEmerald"));
			...
			FurnaceRecipes.smelting().addSmelting(oreBlock.blockID, 3, new ItemStack(Gems, 1, 3));
			FurnaceRecipes.smelting().addSmelting(oreBlock.blockID, 4, new ItemStack(Gems, 1, 4));
			FurnaceRecipes.smelting().addSmelting(oreBlock.blockID, 8, new ItemStack(Gems, 1, 3));
			FurnaceRecipes.smelting().addSmelting(oreBlock.blockID, 9, new ItemStack(Gems, 1, 4));
			FurnaceRecipes.smelting().addSmelting(oreBlock.blockID, 11, new ItemStack(Item.ingotIron, 1));
			FurnaceRecipes.smelting().addSmelting(oreBlock.blockID, 12, new ItemStack(Item.ingotGold, 1));
