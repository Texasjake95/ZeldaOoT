...
public class WorldGenNetherOreMeta extends WorldGenerator
{
	 private int minableBlockId;
     private int numberOfBlocks;
     private int minableMetaId;

     public WorldGenNetherOreMeta(int i, int j, int k)
     {
             minableBlockId = i;
             minableMetaId = j;
             numberOfBlocks = k;
            ...
            for (int l1 = j; l1 <= i1; l1++)
            {
                ...
                for (int i2 = k; i2 <= j1; i2++)
                {
                    ...
                    for (int j2 = l; j2 <= k1; j2++)
                    {
                        ...
                        {
                        	 par1World.setBlockAndMetadata(l1, i2, j2, this.minableBlockId, this.minableMetaId);
                        }
                    }
                }
            }
