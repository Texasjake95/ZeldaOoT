...
public class WorldGenMineableMeta extends WorldGenerator{
	 private int minableBlockId;
     private int numberOfBlocks;
     private int minableMetaId;

     public WorldGenMineableMeta(int i, int j, int k)
     {
             minableBlockId = i;
             minableMetaId = j;
             numberOfBlocks = k;
                     ...
                     for (int var41 = var33; var41 <= var36; ++var41)
                     {
                         ...
                         if (var39 * var39 + var42 * var42 < 1.0D)
                         {
                             for (int var44 = var34; var44 <= var37; ++var44)
                             {
                                 ...
                                 {
                                     par1World.setBlockAndMetadata(var38, var41, var44, this.minableBlockId, this.minableMetaId);
                                 }
                             }
                         }
                     }
