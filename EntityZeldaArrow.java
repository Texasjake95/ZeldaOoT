...
public class EntityZeldaArrow extends Entity
{
    ...
    public EntityZeldaArrow(World par1World)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    }

    public EntityZeldaArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityZeldaArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public EntityZeldaArrow(World par1World, EntityLiving par2EntityLiving, float par3)
    {
    ...
    public void onUpdate()
    {
        ...
        if (explode == true & this.inGround)
        {
        		this.explode();      	
        }
        if (Config.ArrowPowers == true)
        	{
        	if (FireArrow == true & this.inGround & !this.inWater)        	
        ...
        if (IceArrow == true & this.inGround & !this.inWater & !this.handleLavaMovement())
        {Vec3D var16 = Vec3D.createVector(this.posX, this.posY, this.posZ);
        Vec3D var17 = Vec3D.createVector(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
        MovingObjectPosition var3 = this.worldObj.rayTraceBlocks_do_do(var16, var17, false, true);
        var16 = Vec3D.createVector(this.posX, this.posY, this.posZ);
        ...
        int freeze = worldObj.getBlockId(x, y+1, z);
       if (freeze == 0)
        	{worldObj.setBlock(x, y+1, z, Block.snow.blockID);
        	worldObj.markBlockNeedsUpdate(x, y, z);
        	this.setDead();
        	}
        }
        if (IceArrow == true & this.inGround & this.handleLavaMovement())
        {Vec3D var16 = Vec3D.createVector(this.posX, this.posY, this.posZ);
        Vec3D var17 = Vec3D.createVector(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
        MovingObjectPosition var3 = this.worldObj.rayTraceBlocks_do_do(var16, var17, false, true);
        var16 = Vec3D.createVector(this.posX, this.posY, this.posZ);
        var17 = Vec3D.createVector(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
            ...
            if (freeze == 0)
             	{
        	worldObj.setBlock(x, y+1, z, Block.obsidian.blockID);
        	worldObj.markBlockNeedsUpdate(x, y, z);
        	this.setDead();
             	}
        }
        if (IceArrow == true & this.inGround & this.inWater)
        {Vec3D var16 = Vec3D.createVector(this.posX, this.posY, this.posZ);
        Vec3D var17 = Vec3D.createVector(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
        MovingObjectPosition var3 = this.worldObj.rayTraceBlocks_do_do(var16, var17, false, true);
        var16 = Vec3D.createVector(this.posX, this.posY, this.posZ);
        var17 = Vec3D.createVector(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
        	...
        	int z = var3.blockZ;
        	int freeze = worldObj.getBlockId(x, y+1, z);
            if (freeze == Block.waterMoving.blockID || freeze == Block.waterStill.blockID)
             	{
        ...
        else
        {
            ...
            if (var3 != null)
            {
                if (var3.entityHit != null)
                {
                    ...
                    {
                        var22 = ZeldaDamage.ArrowDamage(this, this);
                    }
                    else
                    {
                        var22 = ZeldaDamage.ArrowDamage(this, this.shootingEntity);
                    }
                    if (explode == true)
                    {
                    	var3.entityHit.worldObj.createExplosion(var3.entityHit, this.posX, this.posY, this.posZ, 4.0F);
                    	damage = 0D;
                    }
                    if (IceArrow == true)
                    { 
                    	
                    var3.entityHit.motionX *= 0.25D;
                    var3.entityHit.motionY *= 0.05000000074505806D;
                    var3.entityHit.motionZ *= 0.25D;
                    	
                      var3.entityHit.extinguish();
                    }
